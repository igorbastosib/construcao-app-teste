<!-- Pagina para gerenciar o banco de dados Derby
basta colocar o URL JDBC como http://localhost:9090/saasAnalytics/dbclient.jsp
os outros campos podem ficar vazios.
Digete o SQL corretamente e clique no botao Executar -->
